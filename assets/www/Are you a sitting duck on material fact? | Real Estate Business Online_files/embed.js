...
DISQUS.define(function(a, b) {
	...
	var b = function(a, b) {
		...
		c = {},
		d = function(d) {
			var e = a.require && require.defined && require.defined("common/config") && require("common/config").switches;
			if (!e) return null;
	...
	var a = "default",
		...
		c = {
			...
			profile: "http://disqus.com/embed/profile/",
			onboard: "http://disqus.com/embed/onboard/"
		},
		d = function(a, b) {
		...
		e = function(e, f, g) {
			...
			var i = d(h, document.location.protocol),
				j = DISQUS.extend({
					base: a,
					disqus_version: b
				}, f || {}),
				k = g ? "#" + encodeURIComponent(JSON.stringify(g)) : "";
	...
	DISQUS.extend(o, {
		...
		READY: 1,
		KILLED: 2
	}), DISQUS.extend(o.prototype, DISQUS.Events), o.prototype.sendMessage = function(a, b) {
		var c = k.stringify({
				scope: "client",
				name: a,
				data: b
	...
	}, o.prototype.hide = function() {}, o.prototype.show = function() {}, o.prototype.url = function() {
	...
	var r = function(a) {
		var b = this;
		b.window = null, q.call(b, a), b.styles = DISQUS.extend({
			width: "100%",
			border: "none",
			overflow: "hidden",
			height: "0"
	...
	var s = function(a) {
		q.call(this, a), this.contents = a.contents || "", this.styles = DISQUS.extend({
			width: "100%",
			border: "none",
			overflow: "hidden"
		}, a.styles || {})
	...
	DISQUS.extend(s.prototype, q.prototype), s.prototype.load = function() {
		...
		this.document = this.window.document, this.document.write(this.contents), this.document.close();
		var e, f = this.document.body;
		return f && (e = f.offsetHeight + "px", this.setInlineStyle({
			height: e,
			"min-height": e,
			"max-height": e
		})), this
	...
	function f(a, b) {
		...
		for (var g = 0; g < a.length; g++)
			for (var h = 0; h < b.length; h++) a[g] === b[h] && (d[g + 1][h + 1] = d[g][h] + 1, d[g + 1][h + 1] > c && (c = d[g + 1][h + 1]));
		return c
	}
	...
	function q() {
		var b = a.location.hash,
			c = b && b.match(/(comment|reply|edit)\-([0-9]+)/);
		return c && c[2]
	}
	...
	function s(a) {
		(new Image).src = DISQUS.serialize(v + "/stat.gif", {
			event: a
		})
	}
	...
	function u() {
		for (var a = w.getElementsByTagName("meta"), b = 0; b < a.length; b++)
			if ("viewport" === a[b].getAttribute("name")) return !0;
		return !1
	}
	var v = "//referrer.disqus.com/juggler",
		w = a.document,
		x = function() {
			var a, b, c = function() {
				return !1
			};
			if ("undefined" != typeof w.hidden) a = "hidden", b = "visibilitychange";
			else if ("undefined" != typeof w.mozHidden) a = "mozHidden", b = "mozvisibilitychange";
			else if ("undefined" != typeof w.msHidden) a = "msHidden", b = "msvisibilitychange";
			else {
				if ("undefined" == typeof w.webkitHidden) return {
					isHidden: c,
					listen: c,
					stopListening: c
				};
	...
	var j = i.extend({
		name: null,
		frame: null,
		origin: e.ensureHttpBasedProtocol("http://disqus.com", g),
		state: null,
		getUrl: function() {
	...
	var k = j.extend({
			...
			listenToScrollEvent: function(a) {
				...
				if (c === f) return b.listenTo(DISQUS, "window.scroll", a),
					function() {
			...
			communicateViewportAndScrollStatus: function() {
				...
				if (a) {
					...
					g + f >= c && (h = d >= e, i = h && g >= c);
					var j = this.frame;
					h && (j.sendMessage("window.scroll", a), this.wasNearViewport || j.sendMessage("window.nearViewport")), this.wasNearViewport = h, i !== this.wasInViewport && (j.sendMessage(i ? "window.inViewport" : "window.scrollOffViewport"), this.wasInViewport = i)
				}
			},
		...
		e = d.extend({
			...
			showOnboard: function(a) {
				...
				var d = b.onboard.Onboard({
					...
					threadId: c.threadId,
					forumPk: c.forumPk,
					activeSection: "complete-profile"
				});
				this.stopListening(d), this.listenTo(d, "onboard.profileUpdated", function() {
					...
					activeSection: a.activeSection
				})
			},
			getFrameSettings: function(a) {
				var b = this.settings.fullscreen;
				return a.role = "dialog", a.styles = b ? {
					height: "100%",
					position: "fixed",
					top: 0,
					left: 0,
	...
	return DISQUS.extend(e.prototype, b.app.OnboardAppHelperMixin), {
		Profile: function(a) {
			return new e(a)
		},
		_ProfileApp: e
	...
	var c = function(b) {
		...
		d = "disqus.backplane.channel",
		e = "disqus.backplane.messageUrl";
	return DISQUS.extend(c.prototype, {
		frameEvents: {
		...
		handlers: {
			"identity/login": function(a) {
				var b = a.messageURL,
					c = a.channel;
				("unset" === this.credentials || null === this.credentials || this.credentials.channel !== c || this.credentials.messageUrl !== b) && (this.setCredentials(c, b), this.frame.sendMessage("login", {
		...
		credentialsFromLocalStorage: function() {
			var a = localStorage.getItem(d),
				b = localStorage.getItem(e);
			return this.setCredentials(a, b, !0), this.credentials
		},
		setCredentials: function(a, b, c) {
			return a && b ? (c || (localStorage.setItem(d, a), localStorage.setItem(e, b)), void(this.credentials = {
				channel: a,
				messageUrl: b
	...
	"use strict";
	var b = a.document,
		c = ".disqus-loader{animation:disqus-embed-spinner .7s infinite linear;-webkit-animation:disqus-embed-spinner .7s infinite linear}@keyframes disqus-embed-spinner{0%{transform:rotate(0deg)}100%{transform:rotate(360deg)}}@-webkit-keyframes disqus-embed-spinner{0%{-webkit-transform:rotate(0deg)}100%{-webkit-transform:rotate(360deg)}}",
		d = "//a.disquscdn.com/next/assets/img/loader-bg.6f0512a11a0d2d3c1a28284486e74f1d.png",
		e = DISQUS.next.host,
		f = e.utils,
		...
		h = g.extend({
			...
			events: {
				...
				"frame:indicator:init": function(a, b) {
					if (b.getOffset) {
						for (var c, d, e = ["north", "south"], g = this.indicators, h = b.getOffset().width + "px", i = {
							width: h,
							"min-width": h,
							"max-width": h,
							position: "fixed",
							"z-index": f.MAX_Z_INDEX - 1
						}, j = {
							north: {
								top: "0"
							},
							...
							d = e[k], c = new DISQUS.Sandbox({
								uid: "indicator-" + d,
								container: this.settings.container,
								contents: a[d].contents,
								styles: DISQUS.extend(j[d], i),
								role: "alert",
								type: d
							});
							try {
						...
						this.on({
							...
							"frame:indicator:hide": function(a) {
								...
								if (c) c.hide();
									...
									for (var d = 0; d < e.length; d++) b = e[d], c = g[b], c && c.hide()
							}
						})
					}
				},
			...
			showProfile: function(a) {
				var b = this.settings,
					c = this.profile;
				c && (c.frame.windowName || c.frame.isKilled()) && (c.destroy(), c = null), c || (c = this.profile = e.profile.Profile({
					windowName: a.windowName,
					language: b.language,
					forum: b.forum,
					forumId: a.forumId,
					threadId: a.threadId,
					forumPk: a.forumPk
				}), c.init(), this.listenToOnce(c, "onboard.complete", function() {
					this.frame.sendMessage("onboard.complete")
				}), this.listenTo(c, "onboard.profileUpdated", function() {
					this.frame.sendMessage("onboard.profileUpdated")
				})), c.show({
	...
	return e.app.expose(h, ["list", "listByKey", "get"], i), {
		Lounge: i
	}
	...
	return e.getContainer = function() {
		...
		return this.getValuesFromGlobals(), {
			container: e,
			forum: b.forum,
			sortOrder: b.experiment.sort_order || "default",
			permalink: c.getPermalink(),
			language: b.language,
			typeface: c.isSerif(e) ? "serif" : "sans-serif",
			anchorColor: c.getAnchorColor(e),
			colorScheme: 128 < c.getContrastYIQ(c.getElementStyle(e, "span", "color")) ? "dark" : "light",
			...
			layout: c.isMobileLayout() ? "mobile" : "desktop"
		}
	}, {
		HostConfig: d
	}
	...
	var b, c = DISQUS.use("next.host.loader"),
		...
		h = function(a) {
			if (b) return i({
				reload: !0
			}), DISQUS.log("Use DISQUS.reset instead of reloading embed.js please."), void DISQUS.log("See http://help.disqus.com/customer/portal/articles/472107-using-disqus-on-ajax-sites");
			e.configurator = a;
			var g = e.toJSON();
